...
parser.add_argument('--lr', '--learning-rate', default=1e-3, type=float, metavar='LR',
                    help='Learning rate, such as "1e-3"\n', dest='lr')
...
parser.add_argument('--local-rank', default=-1, type=int,
                    help='Multi card training, indicating the number of graphics cards (processes)')
...
def main():
    ...
    train_loader = DataLoader(train_dataset, batch_size, sampler=train_sampler, num_workers=args.num_workers,
                              drop_last=True)
    test_loader = DataLoader(test_dataset, batch_size, sampler=test_sampler, num_workers=args.num_workers,
                             drop_last=True)
