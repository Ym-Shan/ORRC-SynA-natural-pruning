...
class ResNet18(nn.Module):
    def __init__(self):
        ...
        self.first_block = nn.Sequential(
            layer.AdaptiveAvgPool2d(48),
            layer.Conv2d(2, 64, kernel_size=3, stride=2, padding=1, bias=False),
...
parser = argparse.ArgumentParser(description='spikingjelly LIF CIFAR10DVS Training')
...
parser.add_argument('-N', '--epoch', default=500, type=int, help='Training epoch\n')
parser.add_argument('--decay', default=500, type=int, help='Number of learning rate decay times\n')
...
def main():
    ...
    def dvs_aug(data):
        ...
        transform = transforms.Compose([
            # transforms.Resize(48, antialias=True),
    ...
    train_dataset = CIFAR10DVS('../../data/cifar10dvs/Separate_versions/train_dataset', data_type='frame',
                               split_by='number', frames_number=num_steps, transform=dvs_aug)

    test_dataset = CIFAR10DVS('../../data/cifar10dvs/Separate_versions/test_dataset', data_type='frame',
    ...
    for epoch in range(1, epochs + 1):
        ...
        if dist.get_rank() == 0:
            test_accuracy = test_data_correct_sum / test_data_sum
